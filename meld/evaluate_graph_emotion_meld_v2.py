...
meld_path = {'path' : '/content/drive/MyDrive/MELD.Raw/meld_eval.jsonl'} #YOUR PATH HERE
...
def collate_fn(inputs, processor):
    ...
    for i, item in enumerate(inputs):
        ...
        try:
            ...
            emotion_graph_str = json.dumps(emotion_graph, ensure_ascii=False) #returns a strin
...
if __name__ == '__main__':
    ...
    with open(txt_file, "w", encoding="utf-8") as f:
        for item in results:
            ...
            gt = item["gt"]
            #Converting gt to letters for evaluation later
            match gt:
                case "neutral":
                    gt = a
                case "happy":
